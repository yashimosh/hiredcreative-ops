...
import (
	...
	"github.com/yashimosh/hiredcreative-ops/dashboard/internal/data"
	...
	"github.com/yashimosh/hiredcreative-ops/dashboard/internal/ui/screens"
)
...
func (m appModel) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case screens.PipelineLoadReportMsg:
		archetype, tldr, remote, comp := data.LoadReportSummary(msg.HiredCreativeOpsPath, msg.ReportPath)
		m.pipeline.EnrichReport(msg.ReportPath, archetype, tldr, remote, comp)
		return m, nil

	case screens.PipelineUpdateStatusMsg:
		err := data.UpdateApplicationStatus(msg.HiredCreativeOpsPath, msg.App, msg.NewStatus)
		if err != nil {
...
func main() {
	pathFlag := flag.String("path", ".", "Path to hiredcreative-ops directory")
	flag.Parse()
