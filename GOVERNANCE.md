...
hiredcreative-ops is a fork of [career-ops](https://github.com/santifer/career-ops) (originally by [@santifer](https://github.com/santifer)), maintained by [@yashimosh](https://github.com/yashimosh) under a **BDFL (Benevolent Dictator for Life)** model with a clear path for community members to earn trust and take on responsibilities.
