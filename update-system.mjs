...
/**
 * update-system.mjs — Safe auto-updater for hiredcreative-ops
 *
...
const CANONICAL_REPO = 'https://github.com/yashimosh/hiredcreative-ops.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/yashimosh/hiredcreative-ops/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/yashimosh/hiredcreative-ops/releases/latest';
    ...
    [versionResult, releaseResult] = await Promise.allSettled([
      ...
      fetch(RELEASES_API, {
        headers: {
          ...
          'User-Agent': 'hiredcreative-ops-update-checker',
        },
