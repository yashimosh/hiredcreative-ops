# Contributing to Hired Creative Ops

Thanks for your interest in contributing! Hired Creative Ops is built with Claude Code, and you can use it for development too.
...
- Report bugs via [Issues](https://github.com/yashimosh/hiredcreative-ops/issues)
...
- **PRs that enable auto-submitting applications** without human review. hiredcreative-ops is a decision-support tool, not a spam bot.
...
# Dashboard
cd dashboard && go build -o hiredcreative-dashboard .
./hiredcreative-dashboard --path ..
```

## Need Help?

- [Open a Discussion](https://github.com/yashimosh/hiredcreative-ops/discussions) — fastest way to get answers and connect with other contributors
- [Open an issue](https://github.com/yashimosh/hiredcreative-ops/issues)
