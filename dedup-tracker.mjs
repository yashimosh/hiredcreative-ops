 ...
 *
 * Run: node hiredcreative-ops/dedup-tracker.mjs [--dry-run]
 */
...
// Dedup ONLY within the evaluated table. The "## Email-confirmed submissions"
// table has a different schema (its parts[3] is Role, not Company) and its own
// ID space — grouping it together with the evaluated table would cluster and
// delete real submission rows.
