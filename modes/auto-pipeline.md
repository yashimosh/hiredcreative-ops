...
## Paso 4 — Draft Application Answers (siempre, sin gate por score)

Generar borrador de respuestas para el formulario de aplicación para cualquier rol que no sea Hard SKIP
(ver `modes/_profile.md` § Application Quality Gate — no hay umbral numérico, el score nunca decide si
