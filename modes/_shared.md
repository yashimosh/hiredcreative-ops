# System Context -- hiredcreative-ops
...
<!-- ============================================================
     ...
     that improve with each hiredcreative-ops release.
     ============================================================ -->
...
**Score interpretation (default -- check `modes/_profile.md`'s "Application Quality Gate" section FIRST, it commonly overrides this):**
