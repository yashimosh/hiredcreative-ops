# Geteilter Kontext -- hiredcreative-ops (Deutsch)

<!-- ============================================================
     ANPASSEN DIESER DATEI
     ============================================================
     Diese Datei enthält den geteilten Kontext für alle hiredcreative-ops-Modi
     in der deutschen Variante. Bevor du hiredcreative-ops verwendest, MUSST du:
